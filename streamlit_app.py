...
def plot_selected_ensemble(selected_ensemble, lon, lat):
    ...
    ax.set_extent([26.9, 29.66, -30.74, -28.42], crs=ccrs.PlateCarree())
...
def generate_synthetic_data_lesotho():
    ...
    lat_values = np.linspace(-30.74, -28.42, n_rows)  # Latitudes from 30.66°S to 29.58°S
    lon_values = np.linspace(26.9, 29.66, n_cols)      # Longitudes from 27.0°E to 29.0°E
